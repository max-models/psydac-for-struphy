...
eval_fields_1d_no_weights           = PyccelKernel(eval_fields_1d_no_weights)
eval_fields_1d_irregular_no_weights = PyccelKernel(eval_fields_1d_irregular_no_weights)
eval_fields_1d_weighted             = PyccelKernel(eval_fields_1d_weighted)
eval_fields_1d_irregular_weighted   = PyccelKernel(eval_fields_1d_irregular_weighted)
eval_fields_2d_no_weights           = PyccelKernel(eval_fields_2d_no_weights)
eval_fields_2d_irregular_no_weights = PyccelKernel(eval_fields_2d_irregular_no_weights)
eval_fields_2d_weighted             = PyccelKernel(eval_fields_2d_weighted)
eval_fields_2d_irregular_weighted   = PyccelKernel(eval_fields_2d_irregular_weighted)
eval_fields_3d_no_weights           = PyccelKernel(eval_fields_3d_no_weights)
eval_fields_3d_irregular_no_weights = PyccelKernel(eval_fields_3d_irregular_no_weights)
eval_fields_3d_weighted             = PyccelKernel(eval_fields_3d_weighted)
eval_fields_3d_irregular_weighted   = PyccelKernel(eval_fields_3d_irregular_weighted)
