...
for _name in (
    ...
    'evaluate_dofs_2d_0form', 'evaluate_dofs_2d_1form_hcurl', 'evaluate_dofs_2d_1form_hdiv',
    'evaluate_dofs_2d_2form', 'evaluate_dofs_2d_vec',
    'evaluate_dofs_3d_0form', 'evaluate_dofs_3d_1form', 'evaluate_dofs_3d_2form',
    'evaluate_dofs_3d_3form', 'evaluate_dofs_3d_vec',
):
    setattr(dof_kernels, _name, PyccelKernel(getattr(dof_kernels, _name)))
del _name
